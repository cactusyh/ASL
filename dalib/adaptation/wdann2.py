...
class DomainAdversarialLoss(nn.Module):
    ...
    def forward(self, f_s: torch.Tensor, f_t: torch.Tensor, p_s: torch.Tensor, p_t: torch.Tensor) -> torch.Tensor:
        ...
        loss_s = (self.bce(d_s, d_label_s) * p_s).mean()
        loss_t = (self.bce(d_t, d_label_t) * p_t).mean()
